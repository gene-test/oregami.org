...
@UrlBinding("/game-bootstrap/{gameId=2}")
public class GameBootstrapActionBean extends BaseActionBean implements ActionBean {
	...
	public Resolution defaultHandler() {
		...
		return new ForwardResolution("/jsp/game-bootstrap.jsp");
	}
